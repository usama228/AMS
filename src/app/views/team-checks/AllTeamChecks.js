...
import {  GETUSERSBYTEAMLEAD } from 'app/redux/actions';
...
function AllTeamChecks() {
  ...
  const handleEditClick = (id) => {
    navigate(PATH.CREATETEAMCHECK.replace(":id", id));
  };
    ...
    <SimpleCard>
      ...
      <Box padding={2}>
        <Grid container spacing={2}>
          <Grid item xs={4}>
            {(auth.userType === 'admin' || auth.isTeamLead) && (
              <TextField1
                fullWidth
                select
